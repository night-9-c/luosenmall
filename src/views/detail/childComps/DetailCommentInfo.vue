<template>
  <div id="detail_comment" v-if="Object.keys(commentsInfo).length != 0">
    ...
    <div class="comment_info">
      ...
      <div class="comment_content">
        <div class="content">{{ commentsInfo.content }}</div>
        <p class="content_info">
          {{ commentsInfo.created | dateShow }} {{ commentsInfo.style }}
        </p>
      </div>
    </div>
    <div class="shop_reply" v-if="commentsInfo.explain != null">
      {{ commentsInfo.explain }}
    </div>
    <div class="comment_img" v-if="commentsInfo.images != null">
      <img
        :src="item"
        alt=""
